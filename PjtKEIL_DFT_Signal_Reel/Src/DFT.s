...
;for n in 0..63, n=0, n++ :
;indice=n*k mod 64;
;sum+=cos(indice)*signal(n);
DFT_ModuleAuCarre proc
	;r0=addresse de signal
	;r1=k
	push{r4-r7}
	mov r3,#0
	ldr r4,=sum_cos
...
loop
	...
	ldr r4,=TabCos 
	ldr r6,=TabSin
	ldrsh r4,[r4,r3,lsl#1]  ;r3=cos(r1)
	ldrsh r6,[r6,r3,lsl#1]
	ldrsh r5,[r0,r2,lsl#1];,r2,lsl#1]  ;on charge depuis r0 vers r0, signal(n)
	mul r7,r6,r5
	mul r5,r4,r5 ;r0=signal*cos
	ldr r3,=sum_cos 
	ldr r2,[r3] ;r3=somme actuelle 
	add r5,r2 ; r5=r2+r5
	str r5,[r3] ;sum_cos=r0
	ldr r3,=sum_sin 
	ldr r2,[r3] ;r3=somme actuelle 
	add r7,r2 ; r7=r2+r7
	str r7,[r3] ;sum_cos=r0
	ldr r3,=n 
	ldr r2,[r3]  ;r2=n
	add r2,#1 ;n+=1
	str r2,[r3] ;modif de n
	mov r3,#64 
	cmp r2,r3 ;verifie qu'on est toujours dans la somme
	bcc loop
	ldr r0,=sum_cos   ;mettre au carré et additioner 
	ldr r1,[r0] ;r1=valeur de somme de cos 
	ldr r2,=sum_sin
	ldr r3, [r2]
	mov r0,#0
	mov r4,#0
	smlal r4,r0,r1,r1 ;r0=cos carre
	smlal r4,r0,r3,r3 ;r0=sin carre + cos carre
	pop{r4-r7}
	bx lr
	endp
